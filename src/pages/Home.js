        ...
        if (currentUser) {
          ...
          if (isStudent()) {
            ...
            const completedAssessments = new Set(
              userResults.map((r) => r.assessmentId)
            ).size;
            ...
            <div className="row align-items-center">
              <div className="col-lg-6 mb-5 mb-lg-0">
                ...
                <p className="lead mb-4 fs-4">
                  A comprehensive learning management system that helps students
                  master new skills and instructors deliver effective
                  educational content.
                </p>
                <div className="d-grid gap-2 d-md-flex justify-content-md-start">
                  <Link
                    to="/login"
                    className="btn btn-light btn-lg px-4 me-md-2 fw-medium"
                  >
                ...
                <div className="card h-100 border-0 shadow-sm">
                  <div className="card-body text-center p-4">
                    ...
                    <p className="card-text">
                      Access a wide range of high-quality courses designed for
                      effective learning.
                    </p>
                  </div>
                </div>
                ...
                <div className="card-body">
                  ...
                  <div className="d-grid gap-2">
                    ...
                    <Link
                      ...
                      className="btn btn-sm btn-outline-success"
                    >
                      <i className="bi bi-file-earmark-text me-2"></i>New
                      Assessment
                    </Link>
                    <Link
                      to="/results"
              ...
              <div className="card-header bg-white py-3">
                <div className="d-flex justify-content-between align-items-center">
                  <h5 className="mb-0 fw-bold">
                    <i className="bi bi-collection text-primary me-2"></i>Recent
                    Courses
                  </h5>
                  <Link
                    to="/courses"
            ...
            <div className="card border-0 shadow-sm h-100">
              <div className="card-header bg-white py-3">
                <div className="d-flex justify-content-between align-items-center">
                  ...
                  <Link
                    to={isStudent() ? "/my-results" : "/results"}
                    className="btn btn-sm btn-outline-primary"
                  >
                    View All
                  </Link>
                      ...
                      >
                        <div className="d-flex justify-content-between align-items-center">
                          <div>
                            <h6 className="mb-1">
                              Assessment ID:{" "}
                              {result.assessmentId.substring(0, 8)}...
                            </h6>
